...
def main():
    ...
    st.title('Carteira mensal executavel'); st.markdown(f'<div class="hero"><b>Modelo atual:</b> {SCENARIO_LABEL}<br><span class="note">Carteira Top 15 convertida para compras reais: quantidade inteira de acoes, posicoes irrelevantes removidas e sobra em CDI liquido.</span></div>',unsafe_allow_html=True)
