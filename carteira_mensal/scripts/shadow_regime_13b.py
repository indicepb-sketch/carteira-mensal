...
OUTPUT_FILE = EXCEL_DIR / "shadow_regime_13b.xlsx"
LOG_FILE = LOG_DIR / "shadow_regime_13b.log"
LAMBDA_BETA = 1.5
...
SCENARIOS = [
    ...
    RegimeScenario("13b_balanceado", "Conservador de virada com protecao contra falso positivo em rali amplo.", anti_false_positive_balanced),
    RegimeScenario("13b_conservador", "Versao cautelosa do 13B, mas ainda preserva ralis amplos.", anti_false_positive_conservative),
]
...
def main() -> None:
    ...
    log("Teste 13B - Conservador de Virada com Filtro Anti-Falso-Positivo")
