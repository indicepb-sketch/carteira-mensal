...
INPUT_2023 = EXCEL_DIR / "shadow_backtest_2023.xlsx"
INPUT_35 = EXCEL_DIR / "shadow_teste35_modelo_consolidado_operacional.xlsx"
OUTPUT_FILE = EXCEL_DIR / "shadow_teste35_modelo_consolidado_operacional_2023_2026.xlsx"
LOG_FILE = LOG_DIR / "shadow_teste35_modelo_consolidado_operacional_2023_2026.log"
...
def summarize(monthly: pd.DataFrame) -> pd.DataFrame:
    ...
    rows = [
        {"metrica": "cenario", "valor": "base_28d_cap_efetivo_residual_cdi_liquido_2023_2026"},
...
def main() -> None:
    ...
    with pd.ExcelWriter(OUTPUT_FILE, engine="openpyxl") as writer:
        ...
        monthly_2023.to_excel(writer, sheet_name="Base 2023 CDI", index=False)

    summary_map = dict(zip(summary["metrica"], summary["valor"]))
    log("Modelo Consolidado Operacional estendido 2023-2026")
